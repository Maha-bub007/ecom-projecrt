    ...
    <section class="product-section">
        <div class="container">
            <div class="section-title-outer">
                ...
                <a href="{{ url('/products-viewall') }}" class="product-view-all-btn">
                    View All
                </a>
            </div>
                ...
                @foreach ($hotproduct as $product)
                    <div class="product__item-outer">
                        <div class="product__item-image-outer">
                            <a href="{{ url('/products-datils/' . $product->slug) }}" class="product__item-image-inner">
                                <img src="{{ asset('backend/image/product/' . $product->image) }}" alt="Product Image" />
                            </a>
                            <div class="product__item-add-cart-btn-outer">
                                <a href="{{ url('/product-addtocats/'.$product->id) }}"
                        ...
                        <div class="product__item-info-outer">
                            <a href="{{ url('/products-datils/' . $product->slug) }}" class="product__item-name">
                                {{ $product->name }}
                            </a>
                ...
                @foreach ($newproduct as $product)
                    <div class="product__item-outer">
                        <div class="product__item-image-outer">
                            ...
                            <div class="product__item-add-cart-btn-outer">
                                <a href="{{ url('/product-addtocats/'.$product->id) }}" class="product__item-add-cart-btn-inner">
                                    Add to Cart
                                </a>
                            </div>
                            <div class="product__type-badge-outer">
