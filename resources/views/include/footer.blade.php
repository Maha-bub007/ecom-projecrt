                    ...
                    <div class="footer__item-wrap">
                        ...
                        <ul class="footer__list">
                            <li class="footer__list-item">
                                <a href="{{url('/privace-police')}}" class="footer__list-item-link">
                                    Privacy Policy
                                </a>
                            </li>
                            <li class="footer__list-item">
                    ...
                    <div class="footer__item-wrap">
                        ...
                        <ul class="footer__social-list">
                            <li class="footer__social-list-item">
                                <a href="{{url('https://www.facebook.com/profile.php?id=100031328542209')}}" class="footer__social-list-item-lisk">
                            ...
                            <li class="footer__social-list-item">
                                <a href="{{url('https://www.instagram.com/_inspired__you/')}}" class="footer__social-list-item-lisk">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            <li class="footer__social-list-item">
                                <a href="{{url('https://www.youtube.com/channel/UCSA0tXJ2sinf0-VK9lnsWMQ')}}" class="footer__social-list-item-lisk">
